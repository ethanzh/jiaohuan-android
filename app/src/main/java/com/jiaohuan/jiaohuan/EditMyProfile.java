...
public class EditMyProfile extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap initialCard = myData.getBusiness_card();
        Bitmap initialFlip = myData.getFlipside();
        ...
        Bitmap top = BitmapFactory.decodeResource(EditMyProfile.this.getResources(),R.drawable.card_nyu);
        Bitmap bottom = BitmapFactory.decodeResource(EditMyProfile.this.getResources(),R.drawable.card_flip);
